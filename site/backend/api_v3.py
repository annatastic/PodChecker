...
Original file is located at
    https://colab.research.google.com/drive/1N0MD7Kr0aB98dxSUr4GH5bpA1o1qYRom

### necessary code
"""

#imports and keys
# pip install -U openai-whisper google-genai perplexityai feedparser requests pandas
...
def factcheck(transcript, openai_api_key, perplexity_api_key):
  ...
  #make container for each claim, its associated label, any supporting sources
        #sources column will be a list of lists d.t. multiple sources per fact
